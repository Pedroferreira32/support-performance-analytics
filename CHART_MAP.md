...
| Premiação | Como a nota da liderança foi formada? | Ponte aditiva | base fixa, pontos de quantidade, pontos de avaliação, nota final | contribuição explícita de cada componente para o total |
| Pessoas | Como foram os fechamentos individuais? | Pontos mensais sem ligação | competência, índice, rank, meta | histórico descritivo sem inferir tendência entre regras distintas |
| Auditoria | Quais motivos retiraram mais registros? | Barras horizontais simples | motivo, quantidade | ranking de causas com rótulos diretos e uma única medida |

Paleta: azul-marinho como raiz principal, dourado para atenção e cinzas para contexto. Cor nunca é a única distinção: números, estados e rótulos permanecem escritos no próprio visual.
