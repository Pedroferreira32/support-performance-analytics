...
class ServidorHtmlTest(unittest.TestCase):
    ...
    def test_dashboard_e_apis_principais(self) -> None:
        ...
        self.assertIn("corte de elegibilidade: 85 pontos", html)
        self.assertIn("Premiados", html)
        self.assertIn("Visão do projeto", html)
        self.assertIn("Da base mensal a uma decisão de premiação", html)
        ...
        self.assertIn("KPIs e a pergunta que cada um responde", html)
