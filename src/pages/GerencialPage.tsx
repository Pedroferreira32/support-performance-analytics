    ...
    <AppShell breadcrumb="Painel de performance" title="Resumo gerencial">
      <div className="animate-fade-in-up space-y-5">
        ...
        <SectionCard
          ...
          title={`${competencia.label} versus ${competencia.anterior}`}
          description={currentSnapshot && competencia.anterior === "sem histórico anterior" ? "Esta é a primeira competência armazenada; as variações individuais serão exibidas após o próximo fechamento." : "As variações são descritivas e devem ser lidas junto com o perfil de regra de cada competência."}
          contentClassName="p-0"
        >
